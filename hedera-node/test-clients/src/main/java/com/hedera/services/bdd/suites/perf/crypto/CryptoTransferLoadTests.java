...
public class CryptoTransferLoadTests extends LoadTests {
    private static final Logger log = LogManager.getLogger(CryptoTransferLoadTests.class);
    ...
    public static void main(String... args) {
        ...
        CryptoTransferLoadTests suite = new CryptoTransferLoadTests();
        suite.runSuiteSync();
    }

...
public class AccountBalancesClientSaveLoadTests extends LoadTests {
    private static final Logger LOG = LogManager.getLogger(AccountBalancesClientSaveLoadTests.class);
    ...
    public static void main(String... args) {
        parseArgs(args);
        AccountBalancesClientSaveLoadTests suite = new AccountBalancesClientSaveLoadTests();
        suite.runSuiteSync();
    }
    ...
    private HapiSpec runAccountBalancesClientSaveLoadTest() {
        ...
        return defaultHapiSpec("AccountBalancesClientSaveLoadTests")
                .given(
                        tokenOpsEnablement(),
                        withOpContext(

...
public class FileUpdateLoadTests extends HapiSuite {
    private static final Logger log = LogManager.getLogger(FileUpdateLoadTests.class);

    public static void main(String... args) {
        FileUpdateLoadTests suite = new FileUpdateLoadTests();
        suite.runSuiteSync();
    }

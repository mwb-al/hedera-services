...
@HapiTestSuite
public class InvalidgRPCValuesTests extends HapiSuite {
    private static final Logger log = LogManager.getLogger(InvalidgRPCValuesTests.class);

    public static void main(String... args) throws Exception {
        new InvalidgRPCValuesTests().runSuiteSync();
    }

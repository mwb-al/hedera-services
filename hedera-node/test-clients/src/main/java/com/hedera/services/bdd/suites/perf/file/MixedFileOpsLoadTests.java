...
public class MixedFileOpsLoadTests extends LoadTests {
    private static final Logger log = LogManager.getLogger(MixedFileOpsLoadTests.class);

    public static void main(String... args) {
        parseArgs(args);

        MixedFileOpsLoadTests suite = new MixedFileOpsLoadTests();
        suite.runSuiteSync();
    }
